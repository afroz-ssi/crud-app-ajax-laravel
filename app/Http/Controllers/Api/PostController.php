...
class PostController extends Controller
{
    ...
    public function PostLists(Request $req)
    {
        try {
            try {
                $post_list = Post::with(['user', 'category'])
    ...
    public function EditPost(Request $req)
    {
        ...
        try {
            ...
            $data = Post::with(['user', 'category'])
                ...
                ->get();
            if ($data != null) {
                return response()->json(['status' => 200, 'post_data' => $data], 200);
            } else {
    ...
    public function UpdatePost(Request $req, $id)
    {
        ...
        try {
            ...
            if ($data != null) {
                ...
                if ($updated) {
                    return response()->json(['status' => 200,'req'=>$req->all(), 'data' => $data, 'message' => 'Post updated successfully.'], 200);
                }
